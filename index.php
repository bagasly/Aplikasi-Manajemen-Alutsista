    ...
    <div class="content tab-content" id="nav-tabContent">
        ...
        <div class="card border-0 bg-transparent" style="padding: 3%">
          ...
          <div class="row row-cols-1 row-cols-md-4 g-4 mt-1">
            <div class="col">
              <div class="card">
                <img
                  src="https://www.indomiliter.com/wp-content/uploads/2023/12/3728560917-1-300x167.jpg"
                  class="card-img-top"
                  alt="..."
                />
                <div class="card-body">
      ...
      >
        ...
        <div class="card border-0 bg-transparent" style="padding: 3%">
          ...
          ></div>
          <div
            class="card-body bg-white text-center mh-100"
            style="height: 700px"
          >
